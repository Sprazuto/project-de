        ...
        <VCardText class="d-flex gap-y-3 flex-column">
          <div class="d-flex justify-end">
            <VBtnToggle v-model="preferredCodeLanguage" mandatory variant="outlined" density="compact">
              <VBtn value="ts" :color="preferredCodeLanguage === 'ts' ? 'primary' : 'default'">
                <VIcon icon="custom-typescript" :color="preferredCodeLanguage === 'ts' ? 'primary' : 'secondary'" />
              </VBtn>

              <VBtn value="js" :color="preferredCodeLanguage === 'js' ? 'primary' : 'default'">
                <VIcon icon="custom-javascript" :color="preferredCodeLanguage === 'js' ? 'primary' : 'secondary'" />
              </VBtn>
            </VBtnToggle>
          </div>
