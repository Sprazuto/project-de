...
<template>
  <VDialog :model-value="props.isDialogVisible" max-width="740" @update:model-value="dialogVisibleUpdate">
    <!-- 👉 Dialog close btn -->
    ...
    <VCard class="refer-and-earn-dialog">
      <VCardText class="px-5 px-sm-16 pt-16 pb-10">
        ...
        <p class="mb-1 text-sm">Enter your friend's email address and invite them to join Vuexy 😍</p>
        ...
        <p class="mb-1 text-sm">You can also copy and send it or share it on your social media. 🚀</p>
        <VForm class="d-flex align-center flex-wrap gap-4" @submit.prevent="() => {}">
          <AppTextField density="compact" placeholder="http://referral.link" class="refer-link-input me-1">
