...
# echo "POST ${BASE_URL}/sirup/scrape/single?kodeRUP=61577957"
# curl -s -X POST "http://localhost:9000/v1/spse/sirup/scrape/single?kodeRUP=61577957" | jq '.' || curl -s -X POST "http://localhost:9000/v1/spse/sirup/scrape/single?kodeRUP=61577957"
# echo ""
...
# echo "GET ${BASE_URL}/sirup/data/61577957"
# curl -s -X GET "${BASE_URL}/sirup/data/61577957" | jq '.' || curl -s -X GET "${BASE_URL}/sirup/data/61577957"
# echo ""
